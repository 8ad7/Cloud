def SSE():
    ...
    try:
        ...
        if ssid_line:
            ...
            destination_pathcurs = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\ivecurssfeco.png'
            ...
            destination_pathcurs1 = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\ivesfcurs1eco.png'
            ...
            destination_path3 = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\xcxcx.png'
            ...
            destination_path4 = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\xcxcx--.png'
            ...
            destination_path41 = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\cmd.ttf'
            ...
            destination_pathdg = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\dg.png'
            ...
            destination_pathcurs1dp = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\ivesfcurs1ecodp.png'
            ...
            destination_path3dy = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\xcxcxdy.png'
            ...
            destination_path4cg = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\xcxcx--cg.png'
            ...
            destination_path41cp = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\cmdcp.png'
            ...
            destination_path41cy = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\cmdcy.png'
            ...
            destination_path41cy1 = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\cmdcy1.png'
            ...
            destination_path42 = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\xcxcx--i.png'
            ...
            destination_pathcurs11 = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\ivesfcurs1ecog.png'
            ...
            destination_pathcurs11c = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Temp\\ivesfcurs1ecogccc.png'
            ...
            os.remove(destination_pathcurs11c)
            ...
            class DraggableImageLabe121111s22(QLabel):
                def __init__(self, parent):
                    ...
                    self.offset = None
                    self.setWindowOpacity(0.5)
                    os.remove(destination_pathcurs1dp)
            ...
            class DraggableImageLabe121111s135(QLabel):
                def __init__(self, parent):
                    ...
                    self.offset = None
                    self.setWindowOpacity(0.5)
                    os.remove(destination_path41cp)
            class DraggableImageLabe121111s246(QLabel):
                def __init__(self, parent):
                    ...
                    self.offset = None
                    self.setWindowOpacity(0.5)
                    os.remove(destination_path41cy)
            class DraggableImageLabe121111s2461(QLabel):
                def __init__(self, parent):
                    ...
                    self.offset = None
                    self.setWindowOpacity(0.5)
                    os.remove(destination_path41cy1)
            class DraggableImageLabe121111s115(QLabel):
                    def __init__(self, parent):
                        ...
                        self.offset = None
                        self.setWindowOpacity(0.5)
                        os.remove(destination_pathcurs11)
            ...
            os.remove(destination_pathcurs)
            os.remove(destination_pathcurs1)
            ...
            if ip_address:
                ...
                if ip_info:
                    ipi = ""
                    try:
                        r = json.loads(requests.get("http://ip-api.com/json/?fields=225545").text)
                        if r.get("status") != "success":
                            raise Exception("Failed")
                        data = f"Cellular Network: {'No Found' if not r['mobile'] else 'Found'}\nVPN: {'No Found' if not r['proxy'] else 'Found'}\nIPv4: {r['query']}\nIPv6: {ip_address}\ntimezone: {ip_info['timezone']}\ncountry: {ip_info['country']}\ncountryCode: {ip_info['countryCode']}\ncity: {ip_info['city']}\nzip: {ip_info['zip']}\nlat: {ip_info['lat']}\nlon: {ip_info['lon']}"
                        ipi = data
                    except Exception:
                        ipi = "**Error**"
            else:
                ipi = "**Error**"
            text_area2.setText(ipi)
        ...
        desktop = app.desktop()
        screen = desktop.screenGeometry()
        x = (screen.width() - window.width()) // 2ba
        y = (screen.height() - window.height()) // 2
        window.move(x, y)
        window.show()
        sys.exit(app.exec_())
